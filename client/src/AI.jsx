...
export const AICopilot = ({ environment, currentRecord, currentObject, onNavigateToRecord }) => {
  ...
  const sendMessage = async (text) => {
    ...
    try {
      ...
      setMessages(m=>[...m,{role:"assistant",content:displayText||fallbackMsg,ts:new Date(),hasCreate:!!createData,hasWorkflow:!!workflowData,hasUser:!!userData,hasRole:!!roleData,hasSearch:searchHits.length>0,searchIndex:msgIndex}]);
      ...
      if(searchHits.length>0) setSearchResults(s=>({...s,[msgIndex]:searchHits}));
