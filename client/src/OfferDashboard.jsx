    ...
    <div style={{padding:"28px 32px",fontFamily:F,background:"#F8F7FF",minHeight:"100vh"}}>
      ...
      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:24}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:8,flexWrap:"wrap"}}>
          {[{label:"Overview",nav:"overview",color:"#6B7280"},{label:"Screening",nav:"screening",color:"#7F77DD"},{label:"Interviews",nav:"interviews",color:"#1D9E75"},{label:"Offers",nav:"offers",color:"#D4537E",current:true},{label:"Onboarding",nav:"onboarding",color:"#EF9F27"}]
