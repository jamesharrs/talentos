...
export default function AiGovernance({ environment }) {
  ...
  const complianceItems = [
    { title:"AI Output Labelling", status:"compliant", icon:"eye", description:"All AI-generated content is marked with a visible badge",
      detail:"Vercentic displays a ✦ sparkle badge on every note, email, and communication generated by an AI agent. This satisfies Article 52 of the EU AI Act which requires users to be informed when interacting with or receiving AI-generated content." },
