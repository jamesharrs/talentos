...
const TEST_PEOPLE = [
  ...
  { first_name:'Isabella', last_name:'Romano', email:'isabella.romano@example.com', phone:'+971505678902', person_type:'Employee', status:'Active', current_title:'Head of Operations', location:'Dubai, UAE', years_experience:'14', skills:['Operations Management','Process Improvement','P&L','ERP'], source:'Executive Search', rating:'5', job_title:'Head of Operations', department:'Operations', employment_type:'Full-time', entity:'TalentOS MENA' },
  { first_name:'Khalid', last_name:'Al-Nuaimi', email:'khalid.alnuaimi@example.com', phone:'+971503456799', person_type:'Employee', status:'Active', current_title:'CEO', location:'Dubai, UAE', years_experience:'20', skills:['Leadership','Strategy','P&L','Board Governance'], source:'Board', rating:'5', job_title:'Chief Executive Officer', department:'Executive', employment_type:'Full-time', entity:'TalentOS MENA' },
];
...
const TEST_ORG_UNITS = [
  { name:'TalentOS MENA', type:'company', color:'#3B5BDB', parent_key:null, key:'company' },
