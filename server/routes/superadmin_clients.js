    ...
    objects: [
      {
        ...
        fields: [
          ...
          { name:'Current Company',     api_key:'current_company',     field_type:'text',             is_required:false, show_in_list:true  },
          ...
          { name:'LinkedIn URL',        api_key:'linkedin_url',        field_type:'url',              is_required:false, show_in_list:false },
          ...
          { name:'Years Experience',    api_key:'years_experience',    field_type:'number',           is_required:false, show_in_list:true  },
          ...
          { name:'Identity',            api_key:'section_identity',    field_type:'section_separator',is_required:false, show_in_list:false },
          { name:'Contact',             api_key:'section_contact',     field_type:'section_separator',is_required:false, show_in_list:false },
          { name:'Country',             api_key:'country',             field_type:'country',          is_required:false, show_in_list:false },
          { name:'Professional',        api_key:'section_professional',field_type:'section_separator',is_required:false, show_in_list:false },
          ...
          { name:'Availability',        api_key:'section_availability',field_type:'section_separator',is_required:false, show_in_list:false },
          ...
          { name:'Employment',          api_key:'section_employment',  field_type:'section_separator',is_required:false, show_in_list:false },
          ...
          { name:'Recruitment',         api_key:'section_recruitment', field_type:'section_separator',is_required:false, show_in_list:false },
          ...
          { name:'Diversity & Inclusion',api_key:'section_dei',        field_type:'section_separator',is_required:false, show_in_list:false },
      ...
      },
      {
        ...
        fields: [
          ...
          { name:'Overview',                  api_key:'section_overview',    field_type:'section_separator',is_required:false, show_in_list:false },
          ...
          { name:'Compensation',              api_key:'section_compensation',field_type:'section_separator',is_required:false, show_in_list:false },
          ...
          { name:'Requirements',              api_key:'section_requirements',field_type:'section_separator',is_required:false, show_in_list:false },
          ...
          { name:'Team',                      api_key:'section_team',        field_type:'section_separator',is_required:false, show_in_list:false },
          ...
          { name:'Sourcing Partner',          api_key:'sourcing_partner',    field_type:'people',           is_required:false, show_in_list:false,
            related_object_slug:'people' },
          { name:'Posting',                   api_key:'section_posting',     field_type:'section_separator',is_required:false, show_in_list:false },
          ...
          { name:'Process & Timeline',        api_key:'section_process',     field_type:'section_separator',is_required:false, show_in_list:false },
          ...
          { name:'Approval',                  api_key:'section_approval',    field_type:'section_separator',is_required:false, show_in_list:false },
