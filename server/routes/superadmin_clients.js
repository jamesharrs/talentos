...
const TEMPLATES = {
  ...
  early_careers: {
    label: 'Early Careers',
    description: 'Graduate schemes, internships, placements and apprenticeships — includes Universities, Campus Events, Assessment Centres and Cohorts',
    icon: 'graduation-cap',
    extends: 'core_recruitment',
    people_extra_fields: [
      { name: 'University',          api_key: 'university',           field_type: 'text',         is_required: false, show_in_list: true  },
      { name: 'Degree Subject',      api_key: 'degree_subject',       field_type: 'text',         is_required: false, show_in_list: true  },
      { name: 'Degree Type',         api_key: 'degree_type',          field_type: 'select',       is_required: false, show_in_list: true,
        options: ['BSc','BA','BEng','MEng','MSc','MA','MBA','PhD','HND','Foundation','Other'] },
      { name: 'Academic Grade',      api_key: 'academic_grade',       field_type: 'select',       is_required: false, show_in_list: true,
        options: ['First','2:1','2:2','Third','Pass','Distinction','Merit','Not Yet Known'] },
      { name: 'Expected Graduation', api_key: 'expected_graduation',  field_type: 'date',         is_required: false, show_in_list: true  },
      { name: 'Graduation Year',     api_key: 'graduation_year',      field_type: 'number',       is_required: false, show_in_list: true  },
      { name: 'Programme Type',      api_key: 'programme_type',       field_type: 'select',       is_required: false, show_in_list: true,
        options: ['Graduate Scheme','Summer Internship','Year in Industry','Placement Year','Apprenticeship','Spring Insight','Campus Hire','Other'] },
      { name: 'Programme Year',      api_key: 'programme_year',       field_type: 'select',       is_required: false, show_in_list: false,
        options: ['Year 1','Year 2','Year 3','Final Year','Postgraduate','N/A'] },
      { name: 'Target Business Area',api_key: 'target_business_area', field_type: 'text',         is_required: false, show_in_list: true  },
      { name: 'Campus Event Source', api_key: 'campus_event_source',  field_type: 'text',         is_required: false, show_in_list: false },
      { name: 'Target University',   api_key: 'target_university',    field_type: 'boolean',      is_required: false, show_in_list: true  },
      { name: 'Work Authorization',  api_key: 'work_authorization',   field_type: 'select',       is_required: false, show_in_list: false,
        options: ['UK/EU Citizen','Settled Status','Pre-Settled Status','Student Visa','Graduate Visa','Tier 2/Skilled Worker','Other','Prefer not to say'] },
      { name: 'Online Test Score',   api_key: 'online_test_score',    field_type: 'number',       is_required: false, show_in_list: false },
      { name: 'Online Test Date',    api_key: 'online_test_date',     field_type: 'date',         is_required: false, show_in_list: false },
      { name: 'AC Score',            api_key: 'ac_overall_score',     field_type: 'number',       is_required: false, show_in_list: true  },
      { name: 'AC Recommendation',   api_key: 'ac_recommendation',    field_type: 'select',       is_required: false, show_in_list: true,
        options: ['Strong Hire','Hire','Borderline','No Hire','Strong No Hire','Pending'] },
      { name: 'Cohort Year',         api_key: 'cohort_year',          field_type: 'number',       is_required: false, show_in_list: true  },
      { name: 'Programme Start Date',api_key: 'programme_start_date', field_type: 'date',         is_required: false, show_in_list: true  },
      { name: 'Returner',            api_key: 'is_returner',          field_type: 'boolean',      is_required: false, show_in_list: false },
      { name: 'Disability Declared', api_key: 'disability_declared',  field_type: 'boolean',      is_required: false, show_in_list: false },
      { name: 'First Generation',    api_key: 'first_generation',     field_type: 'boolean',      is_required: false, show_in_list: false },
      { name: 'Free School Meals',   api_key: 'free_school_meals',    field_type: 'boolean',      is_required: false, show_in_list: false },
    ],
    jobs_extra_fields: [
      { name: 'Programme Type',      api_key: 'programme_type',       field_type: 'select',       is_required: false, show_in_list: true,
        options: ['Graduate Scheme','Summer Internship','Year in Industry','Placement Year','Apprenticeship','Spring Insight','Other'] },
      { name: 'Cohort Size',         api_key: 'cohort_size',          field_type: 'number',       is_required: false, show_in_list: true  },
      { name: 'Programme Start Date',api_key: 'programme_start_date', field_type: 'date',         is_required: false, show_in_list: true  },
      { name: 'Application Opens',   api_key: 'application_opens',    field_type: 'date',         is_required: false, show_in_list: false },
      { name: 'Application Closes',  api_key: 'application_closes',   field_type: 'date',         is_required: false, show_in_list: true  },
      { name: 'AC Date',             api_key: 'ac_date',              field_type: 'date',         is_required: false, show_in_list: false },
      { name: 'Salary / Stipend',    api_key: 'stipend',              field_type: 'currency',     is_required: false, show_in_list: true  },
      { name: 'Degree Requirements', api_key: 'degree_requirements',  field_type: 'text',         is_required: false, show_in_list: false },
      { name: 'Year of Study',       api_key: 'year_of_study',        field_type: 'multi_select', is_required: false, show_in_list: false,
        options: ['Year 1','Year 2','Year 3','Final Year','Postgraduate','Any'] },
      { name: 'Returning Offer',     api_key: 'returning_offer',      field_type: 'boolean',      is_required: false, show_in_list: false },
    ],
    extra_objects: [
      {
        slug: 'universities', name: 'University', plural_name: 'Universities',
        icon: 'book-open', color: '#7C3AED', is_system: false,
        fields: [
          { name: 'University Name',    api_key: 'university_name',    field_type: 'text',         is_required: true,  show_in_list: true  },
          { name: 'City',               api_key: 'city',               field_type: 'text',         is_required: false, show_in_list: true  },
          { name: 'Country',            api_key: 'country',            field_type: 'text',         is_required: false, show_in_list: true  },
          { name: 'Tier',               api_key: 'tier',               field_type: 'select',       is_required: false, show_in_list: true,
            options: ['Target','Core','Semi-Target','Non-Target','New Relationship'] },
          { name: 'Campus Team Contact',api_key: 'campus_contact',     field_type: 'text',         is_required: false, show_in_list: true  },
          { name: 'Contact Email',      api_key: 'contact_email',      field_type: 'email',        is_required: false, show_in_list: false },
          { name: 'Relationship Owner', api_key: 'relationship_owner', field_type: 'text',         is_required: false, show_in_list: true  },
          { name: 'Ranking',            api_key: 'ranking',            field_type: 'number',       is_required: false, show_in_list: false },
          { name: 'Strong Subjects',    api_key: 'strong_subjects',    field_type: 'multi_select', is_required: false, show_in_list: false,
            options: ['Computer Science','Engineering','Finance','Economics','Law','Natural Sciences','PPE','Mathematics','Physics','Business','Other'] },
          { name: 'Events This Year',   api_key: 'events_this_year',   field_type: 'number',       is_required: false, show_in_list: false },
          { name: 'Hires This Year',    api_key: 'hires_this_year',    field_type: 'number',       is_required: false, show_in_list: true  },
          { name: 'Hires Last Year',    api_key: 'hires_last_year',    field_type: 'number',       is_required: false, show_in_list: false },
          { name: 'Diversity Focus',    api_key: 'diversity_focus',    field_type: 'boolean',      is_required: false, show_in_list: false },
          { name: 'Society Partners',   api_key: 'society_partners',   field_type: 'textarea',     is_required: false, show_in_list: false },
          { name: 'Notes',              api_key: 'notes_text',         field_type: 'textarea',     is_required: false, show_in_list: false },
          { name: 'Status',             api_key: 'status',             field_type: 'select',       is_required: false, show_in_list: true,
            options: ['Active','Paused','New','Former'] },
        ]
      },
      {
        slug: 'campus_events', name: 'Campus Event', plural_name: 'Campus Events',
        icon: 'calendar', color: '#0284C7', is_system: false,
        fields: [
          { name: 'Event Name',             api_key: 'event_name',         field_type: 'text',         is_required: true,  show_in_list: true  },
          { name: 'Event Type',             api_key: 'event_type',         field_type: 'select',       is_required: true,  show_in_list: true,
            options: ['Careers Fair','Presentation / Insight','Networking Evening','Hackathon','Society Sponsorship','Campus Interview Day','Virtual Event','Spring Week','Open Day','Other'] },
          { name: 'University',             api_key: 'university_name',    field_type: 'text',         is_required: false, show_in_list: true  },
          { name: 'Date',                   api_key: 'event_date',         field_type: 'date',         is_required: true,  show_in_list: true  },
          { name: 'Location',               api_key: 'location',           field_type: 'text',         is_required: false, show_in_list: true  },
          { name: 'Format',                 api_key: 'format',             field_type: 'select',       is_required: false, show_in_list: true,
            options: ['In-Person','Virtual','Hybrid'] },
          { name: 'Target Programme',       api_key: 'target_programme',   field_type: 'multi_select', is_required: false, show_in_list: false,
            options: ['Graduate Scheme','Summer Internship','Year in Industry','Apprenticeship','Spring Insight','All'] },
          { name: 'Owner',                  api_key: 'event_owner',        field_type: 'text',         is_required: false, show_in_list: true  },
          { name: 'Expected Attendees',     api_key: 'expected_attendees', field_type: 'number',       is_required: false, show_in_list: false },
          { name: 'Actual Attendees',       api_key: 'actual_attendees',   field_type: 'number',       is_required: false, show_in_list: true  },
          { name: 'Applications Generated', api_key: 'apps_generated',     field_type: 'number',       is_required: false, show_in_list: true  },
          { name: 'Hires Generated',        api_key: 'hires_generated',    field_type: 'number',       is_required: false, show_in_list: false },
          { name: 'Cost',                   api_key: 'cost',               field_type: 'currency',     is_required: false, show_in_list: false },
          { name: 'Cost Per Hire',          api_key: 'cost_per_hire',      field_type: 'currency',     is_required: false, show_in_list: false },
          { name: 'Status',                 api_key: 'status',             field_type: 'select',       is_required: false, show_in_list: true,
      ...
      {
        slug: 'assessment_centres', name: 'Assessment Centre', plural_name: 'Assessment Centres',
        icon: 'clipboard', color: '#DC2626', is_system: false,
        fields: [
          { name: 'AC Name',            api_key: 'ac_name',            field_type: 'text',         is_required: true,  show_in_list: true  },
          { name: 'Date',               api_key: 'ac_date',            field_type: 'date',         is_required: true,  show_in_list: true  },
          { name: 'Location',           api_key: 'location',           field_type: 'text',         is_required: false, show_in_list: true  },
          { name: 'Format',             api_key: 'format',             field_type: 'select',       is_required: false, show_in_list: true,
            options: ['In-Person','Virtual','Hybrid'] },
          { name: 'Programme',          api_key: 'programme_type',     field_type: 'select',       is_required: false, show_in_list: true,
            options: ['Graduate Scheme','Summer Internship','Year in Industry','Placement Year','Apprenticeship','Spring Insight'] },
          { name: 'Business Area',      api_key: 'business_area',      field_type: 'text',         is_required: false, show_in_list: true  },
          { name: 'Cohort Year',        api_key: 'cohort_year',        field_type: 'number',       is_required: false, show_in_list: true  },
          { name: 'Invited Count',      api_key: 'invited_count',      field_type: 'number',       is_required: false, show_in_list: true  },
          { name: 'Attended Count',     api_key: 'attended_count',     field_type: 'number',       is_required: false, show_in_list: true  },
          { name: 'Offers Made',        api_key: 'offers_made',        field_type: 'number',       is_required: false, show_in_list: true  },
          { name: 'Offers Accepted',    api_key: 'offers_accepted',    field_type: 'number',       is_required: false, show_in_list: false },
          { name: 'AC Lead',            api_key: 'ac_lead',            field_type: 'text',         is_required: false, show_in_list: true  },
          { name: 'Exercises',          api_key: 'exercises',          field_type: 'multi_select', is_required: false, show_in_list: false,
            options: ['Group Exercise','Case Study','Presentation','Written Exercise','Interview','Role Play','E-tray','Psychometric','Strengths Interview'] },
          { name: 'Pass Rate %',        api_key: 'pass_rate_pct',      field_type: 'number',       is_required: false, show_in_list: false },
          { name: 'Status',             api_key: 'status',             field_type: 'select',       is_required: false, show_in_list: true,
            options: ['Planned','Invitations Sent','Completed','Decisions Made','Cancelled'] },
          { name: 'Notes',              api_key: 'notes_text',         field_type: 'textarea',     is_required: false, show_in_list: false },
        ]
      },
      {
        slug: 'cohorts_intake', name: 'Intake Cohort', plural_name: 'Intake Cohorts',
        icon: 'users', color: '#059669', is_system: false,
        fields: [
          { name: 'Cohort Name',          api_key: 'cohort_name',          field_type: 'text',     is_required: true,  show_in_list: true  },
          { name: 'Programme Type',       api_key: 'programme_type',       field_type: 'select',   is_required: true,  show_in_list: true,
            options: ['Graduate Scheme','Summer Internship','Year in Industry','Placement Year','Apprenticeship','Spring Insight','Mixed'] },
          { name: 'Cohort Year',          api_key: 'cohort_year',          field_type: 'number',   is_required: true,  show_in_list: true  },
          { name: 'Business Area',        api_key: 'business_area',        field_type: 'text',     is_required: false, show_in_list: true  },
          { name: 'Start Date',           api_key: 'start_date',           field_type: 'date',     is_required: false, show_in_list: true  },
          { name: 'End Date',             api_key: 'end_date',             field_type: 'date',     is_required: false, show_in_list: false },
          { name: 'Target Size',          api_key: 'target_size',          field_type: 'number',   is_required: false, show_in_list: true  },
          { name: 'Actual Size',          api_key: 'actual_size',          field_type: 'number',   is_required: false, show_in_list: true  },
          { name: 'Offers Made',          api_key: 'offers_made',          field_type: 'number',   is_required: false, show_in_list: false },
          { name: 'Offers Accepted',      api_key: 'offers_accepted',      field_type: 'number',   is_required: false, show_in_list: false },
          { name: 'Offer Acceptance %',   api_key: 'offer_acceptance_pct', field_type: 'number',   is_required: false, show_in_list: false },
          { name: 'Reneges',              api_key: 'reneges',              field_type: 'number',   is_required: false, show_in_list: false },
          { name: 'Diversity %',          api_key: 'diversity_pct',        field_type: 'number',   is_required: false, show_in_list: false },
          { name: 'Target Universities',  api_key: 'target_universities',  field_type: 'textarea', is_required: false, show_in_list: false },
          { name: 'Onboarding Lead',      api_key: 'onboarding_lead',      field_type: 'text',     is_required: false, show_in_list: true  },
          { name: 'Portal Token',         api_key: 'portal_token',         field_type: 'text',     is_required: false, show_in_list: false },
          { name: 'Status',               api_key: 'status',               field_type: 'select',   is_required: false, show_in_list: true,
            options: ['Planning','Recruiting','Offers Out','Accepted','Onboarding','Active','Complete'] },
          { name: 'Notes',                api_key: 'notes_text',           field_type: 'textarea', is_required: false, show_in_list: false },
        ]
      },
      {
        slug: 'ec_programmes', name: 'Programme', plural_name: 'Programmes',
        icon: 'layers', color: '#F59E0B', is_system: false,
        fields: [
          { name: 'Programme Name',  api_key: 'programme_name',  field_type: 'text',         is_required: true,  show_in_list: true  },
          { name: 'Programme Type',  api_key: 'programme_type',  field_type: 'select',       is_required: true,  show_in_list: true,
            options: ['Graduate Scheme','Summer Internship','Year in Industry','Placement Year','Apprenticeship','Spring Insight','Other'] },
          { name: 'Business Area',   api_key: 'business_area',   field_type: 'text',         is_required: false, show_in_list: true  },
          { name: 'Duration',        api_key: 'duration',        field_type: 'text',         is_required: false, show_in_list: true  },
          { name: 'Locations',       api_key: 'locations',       field_type: 'multi_select', is_required: false, show_in_list: false,
            options: ['London','Manchester','Birmingham','Edinburgh','Remote','Various'] },
          { name: 'Annual Intake',   api_key: 'annual_intake',   field_type: 'number',       is_required: false, show_in_list: true  },
          { name: 'Salary',          api_key: 'salary',          field_type: 'currency',     is_required: false, show_in_list: true  },
          { name: 'Degree Required', api_key: 'degree_required', field_type: 'boolean',      is_required: false, show_in_list: false },
          { name: 'Degree Subjects', api_key: 'degree_subjects', field_type: 'multi_select', is_required: false, show_in_list: false,
            options: ['Any','STEM','Computer Science','Engineering','Finance','Economics','Law','Business','Sciences','Arts & Humanities'] },
          { name: 'Application URL', api_key: 'application_url', field_type: 'url',          is_required: false, show_in_list: false },
          { name: 'Description',     api_key: 'description',     field_type: 'textarea',     is_required: false, show_in_list: false },
          { name: 'Status',          api_key: 'status',          field_type: 'select',       is_required: false, show_in_list: true,
    ...
    default_roles: [
      { name: 'Super Admin',       permissions: { create:true,  read:true,  edit:true,  delete:true,  admin:true  }, color: '#7C3AED' },
      { name: 'Campus Recruiter',  permissions: { create:true,  read:true,  edit:true,  delete:false, admin:false }, color: '#0284C7' },
      { name: 'Assessor',          permissions: { create:false, read:true,  edit:true,  delete:false, admin:false }, color: '#DC2626' },
      { name: 'Business Champion', permissions: { create:false, read:true,  edit:false, delete:false, admin:false }, color: '#F59E0B' },
      { name: 'Viewer',            permissions: { create:false, read:true,  edit:false, delete:false, admin:false }, color: '#9DA8C7' },
    ],
  },
};
...
function buildTemplate(key, snapshotData) {
  ...
  if (tpl.extends) {
    ...
    // Inject people_extra_fields into the people object
    if (tpl.people_extra_fields && tpl.people_extra_fields.length) {
      const peopleObj = objects.find(o => o.slug === 'people');
      if (peopleObj) peopleObj.fields = [...(peopleObj.fields || []), ...tpl.people_extra_fields];
    }
